...
export default function ProductList() {
    ...
    const handleAddToCart = (product) => {
        ...
        toast.success(`${product.productName} sepete eklendi!`, { theme: "colored" })
    }
                ...
                <Table.Body>
                    {
                        products.map((product, key) => (
                            <Table.Row key={key} style={{textAlign: "center"}}>
                                ...
                                <Table.Cell><Button icon="cart arrow down" primary onClick={() => handleAddToCart(product)}></Button></Table.Cell>
                            </Table.Row>
                        ))
                    }
                </Table.Body>
